        ...
        return (
            <TableRow key={row.id} selectable={false}>
                <TableHeaderColumn style={{width:'50px'}}>
                    <IconButton onTouchTap={() => this.editCarFormActions().open(o2car(row))}>
                        <ModeEdit/>
                    </IconButton>
                    <IconButton onTouchTap={() => this.deleteCarDialogActions().open(o2car(row))}>
                        <DeleteForever/>
                    </IconButton>
                </TableHeaderColumn>
    ...
    header() {
        return (
            <TableHeader selectable={false} displaySelectAll={false} enableSelectAll={false} adjustForCheckbox={false}>
                <TableRow>
                    <TableHeaderColumn style={{width:'50px'}}>
                        <FloatingActionButton mini={true} onTouchTap={this.addCarFormActions().open}>
                            <ContentAdd />
