        ...
        return (
            <TableRow key={row.id} selectable={false}>
                <TableHeaderColumn style={{width:'50px'}}>
                    <IconButton onTouchTap={() => this.editCarTypeFormActions().open(o2ct(row))}>
                        <ModeEdit/>
                    </IconButton>
                    <IconButton onTouchTap={() => this.deleteCarTypeDialogActions().open(o2ct(row))}>
                        <DeleteForever/>
                    </IconButton>
                </TableHeaderColumn>
                {colCell(row.name)}
    ...
    header() {
        return (
            <TableHeader selectable={false} displaySelectAll={false} enableSelectAll={false} adjustForCheckbox={false}>
                <TableRow>
                    <TableHeaderColumn style={{width:'50px'}}>
                        <FloatingActionButton mini={true} onTouchTap={this.addCarTypeFormActions().open}>
                            <ContentAdd />
