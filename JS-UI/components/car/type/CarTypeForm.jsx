...
import {carTypeFieldsMap, carTypeRequiredFieldList} from '../../../constants/constants';
import * as V from '../../../utils/validation';

class CarTypeForm extends Component {
    ...
    text(fieldName, validateFields, focusField) {
        ...
        const info = carTypeFieldsMap.get(fieldName);
        ...
        return (
            <TextField
                ...
                value={this.properties().carType[fieldName]}
        ...
        const actions = [
            <div>
                <FlatButton
                    ...
                    onTouchTap={() => {
                        this.actions().validate(carTypeRequiredFieldList.toArray());
