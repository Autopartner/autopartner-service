        ...
        return (
            <TableRow key={row.id} selectable={false}>
                <TableHeaderColumn style={{width:'50px'}}>
                    <IconButton onTouchTap={() => this.editOrderFormActions().open(o2order(row))}>
                        <ModeEdit/>
                    </IconButton>
                    <IconButton onTouchTap={() => this.deleteOrderDialogActions().open(o2order(row))}>
                        <DeleteForever/>
                    </IconButton>
                </TableHeaderColumn>
    ...
    header() {
        return (
            <TableHeader selectable={false} displaySelectAll={false} enableSelectAll={false} adjustForCheckbox={false}>
                <TableRow>
                    <TableHeaderColumn style={{width:'50px'}}>
                        <FloatingActionButton mini={true} onTouchTap={this.addOrderFormActions().open}>
                            <ContentAdd />
