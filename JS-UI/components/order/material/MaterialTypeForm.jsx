...
import {materialTypeFieldsMap, materialTypeRequiredFieldList} from '../../../constants/constants';
...
class MaterialTypeForm extends Component {
    ...
    text(fieldName, validateFields, focusField) {
        ...
        const info = materialTypeFieldsMap.get(fieldName);
        ...
        return (
            <TextField
                ...
                value={this.properties().materialType[fieldName]}
        ...
        const actions = [
            <div>
                <FlatButton
                    ...
                    onTouchTap={() => {
                        this.actions().validate(materialTypeRequiredFieldList.toArray());
