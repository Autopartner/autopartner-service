        ...
        return (
            <TableRow key={row.id} selectable={false}>
                <TableHeaderColumn style={{width:'50px'}}>
                    <IconButton onTouchTap={() => this.editTaskFormActions().open(o2task(row))}>
                        <ModeEdit/>
                    </IconButton>
                    <IconButton onTouchTap={() => this.deleteTaskDialogActions().open(o2task(row))}>
                        <DeleteForever/>
                    </IconButton>
                </TableHeaderColumn>
                {colCell(row.name)}
    ...
    header() {
        return (
            <TableHeader selectable={false} displaySelectAll={false} enableSelectAll={false} adjustForCheckbox={false}>
                <TableRow>
                    <TableHeaderColumn style={{width:'50px'}}>
                        <FloatingActionButton mini={true} onTouchTap={this.addTaskFormActions().open}>
                            <ContentAdd />
