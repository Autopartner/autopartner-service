...
public class TaskIntegrationTest extends AbstractIntegrationTest{
  ...
  public void givenCategoryId_whenGetAllTasksByCategory_thenReturnTasks() throws Exception{
    ...
    TaskCategory category2 = TaskCategoryFixture.createTaskCategoryWithDifferentName();
    categoryRepository.save(category2);

    List<Task> tasks = List.of(TaskFixture.createTask(category), TaskFixture.createTask(category), TaskFixture.createTask(category2));
    taskRepository.saveAll(tasks);
